...
const OurPartners = () => {
  const partners = [
    // 1. Birmingham Youth City Board – first
    {
      id: 1,
      name: 'Birmingham Youth City Board',
      tagline: "Young Voices Shaping Birmingham's Future",
      website:
        'https://www.birmingham.gov.uk/info/50283/birmingham_city_partnership/2666/birmingham_city_partnership_board/3',
      contactPage:
        'https://www.birmingham.gov.uk/info/50283/birmingham_city_partnership/2666/birmingham_city_partnership_board/3',
    ...
    // 2. EY Foundation – second, with workshop images
    {
      id: 2,
      name: 'EY Foundation',
      tagline: 'Independent charity supporting young futures',
      website: 'https://www.eyfoundation.com/',
      contactPage: 'https://www.eyfoundation.com/en_uk/contact-us',
      email: 'enquiries@eyfoundation.ey.com',
      phone: '+44 20 7951 3133',
      address: '1 More London Place, London, SE1 2AF, United Kingdom',
      description:
        'An independent charity set up by EY that works with young people from low-income backgrounds, employers and social entrepreneurs to help them gain employability skills, financial literacy training, paid work experience and mentoring so they can progress into work, higher education or self-employment.',
      logo: '/EYFoundation.webp', // your EY logo asset
      ...
      // NEW: EY workshop images – update these paths
      workshopImages: [
        '/images/ey-session-1.jpg',
        '/images/ey-session-2.jpg',
        '/images/ey-session-3.jpg',
        '/images/ey-session-4.jpg'
      ]
    },

    // 3. SNJ Charitable Trust – third
    {
      id: 3,
    ...
    },
    {
      ...
      addressIndia:
        '2-2-647/A/85, Saibaba Nagar Colony, Amberpet, Telangana 500013, Hyderabad, India',
      description:
    ...
    },
    {
      ...
      address:
        '1121, Upper Ground Floor, Mahipalpur Bypass, Opposite Arjun Camp, New Delhi 110037, India',
      description:
              ...
              <div className="grid lg:grid-cols-[1fr_1.4fr] gap-0 items-stretch">
                ...
                <div className="p-6 sm:p-8 rounded-b-3xl lg:rounded-r-3xl lg:rounded-bl-none">
                  <div className="flex items-start gap-3 mb-5">
                    <div
                      className={`w-11 h-11 rounded-xl ${partner.badgeBg} flex items-center justify-center shrink-0`}
                    >
                    ...
                    <div>
                      ...
                      <p
                        className={`text-sm font-medium mt-0.5 ${partner.badgeText}`}
                      >
                        {partner.tagline}
                      </p>
                  ...
                  {/* ── Big Four Partnership inside EY card only ── */}
                  {partner.workshopImages && partner.workshopImages.length > 0 && (
                    <div className="mb-6">
                      <h3 className="text-sm sm:text-base font-semibold text-slate-900">
                        EY Foundation Financial Literacy Workshop Highlights
                      </h3>
                      <p className="mt-2 text-xs sm:text-sm text-slate-700 leading-6">
                        Partnered with EY Foundation to impart Financial Literacy
                        workshop to the 16–18 year old as part of early careers
                        enrichment programme.
                      </p>
                      <div className="mt-3 grid grid-cols-2 gap-3 sm:gap-4">
                        {partner.workshopImages.map((src, index) => (
                          <img
                            key={index}
                            src={src}
                            alt={`EY Foundation financial literacy workshop ${index + 1}`}
                            className="w-full h-36 sm:h-40 object-cover rounded-xl shadow-sm"
                          />
                        ))}
                      </div>
                    </div>
        ...
        <div className="mt-14 rounded-3xl bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 p-0.5 shadow-xl">
          <div className="bg-white rounded-[calc(1.5rem-2px)] px-8 py-7 text-center">
            ...
            <p className="text-slate-700 text-base leading-7 max-w-2xl mx-auto">
              ...
              financial confidence for children, families, and communities. Interested
              in partnering with ChequeItOut?{' '}
              <a
                href="/about"
